...
<p className="legal-lead">
      ...
      <section>
        <h2 className="legal-h2">The use of the Cookies</h2>
        <h3 className="legal-h3">Type of Cookies We Use</h3>
        <p>
          ...
          <li>
            <dl>
              ...
              <dd>
                ...
                can place Cookies to enable them to show adverts which We think
                will be relevant to your interests while You are on third party
                websites.
              </dd>
            </dl>
          </li>
        ...
        <h3 className="legal-h3">Your Choices Regarding Cookies</h3>
        <p>
      ...
      <section>
        <h2 className="legal-h2">More information about Cookies</h2>
        <p>
