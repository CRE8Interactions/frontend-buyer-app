...
<div className="legal-header">
      ...
      <section>
        <h2 className="legal-h2">External Links Disclaimer</h2>
        <p>
      ...
      <section>
        <h2 className="legal-h2">Advertising Disclaimer</h2>
        <p>
          Third party advertisements and links to third party websites may also
          appear while using the Service. The Company does not make any
          representation as to the accuracy or suitability of any of the
          information contained in those advertisements or websites and does not
          accept any responsibility or liability for the conduct or content of
          those advertisements and websites and the offerings made by the
          third-parties.
        </p>
        <p>
          Third party advertisements and links to other websites where goods or
          services are advertised are not endorsements or recommendations by the
          Company of the third party sites, goods or services. The Company takes
      ...
      <section>
        ...
        <p>
          ...
          in the information contained on the Service. The Company is not
          responsible for any errors or omissions, or for the results obtained
          from the use of this information.
        </p>
      </section>
      <section>
        <h2 className="legal-h2">Fair Use Disclaimer</h2>
        <p>
        ...
        <p>
          If You wish to use copyrighted material from the Servic You must
          obtain permission from the copyright owner.
        </p>
      </section>
      <section>
        <h2 className="legal-h2">Views Expressed Disclaimer</h2>
        <p>
      ...
      <section>
        <h2 className="legal-h2">No Responsibility Disclaimer</h2>
        <p>
