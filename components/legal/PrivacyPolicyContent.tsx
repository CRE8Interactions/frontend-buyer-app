...
<p className="legal-lead">
      ...
      <div className="legal-header">
        <h2 className="legal-h2">Interpretation and Definitions</h2>
      </div>

      <h3 className="legal-h3">Interpretation</h3>
      <p>
      ...
      <section>
        <h3 className="legal-h3">Definitions</h3>
        ...
        <ul>
          <li>
            <dl>
              <dt>Account </dt>
              <dd>
                means a unique account created for You to access our Services or
                ports of our Service.
              </dd>
            </dl>
          </li>
          <li>
            <dl>
              ...
              <dd>
                ...
                on behalf of which such information is collected and that alone,
          ...
          <li>
            <dl>
              ...
              <dd>
                ...
                this Agreement) refers to Blocktickets LLC, 320 W MAIN ST
                LEWISVILLE, TX 75057.
              </dd>
            </dl>
          </li>
          ...
          <li>
            <dl>
              ...
              <dd>
                is a public profile named Blocktickets specifically created by
                the Company on the Facebook social network, accessible from{" "}
                <a
                  href="https://www.facebook.com/blocktickets.xyz"
          ...
          <li>
            <dl>
              ...
              <dd>
                ...
                individual. For the purposes for GDPR, Personal Data means any
                ...
                of the CCPA, Personal Data means any information that
      ...
      <section>
        <h2 className="legal-h2">Collecting Your Personal Data</h2>
        <h3 className="legal-h3">Type of Data Collected</h3>
        <h3 className="legal-h3">Personal Data</h3>
        <p>
        ...
        <p>
          ...
          Your contact list associated with that account. You may also have the
          option of sharing additional information with the Company through Your
          Third-Party Social Media Service's account. If You choose to provide
          such information and Personal Data, during registration or otherwise,
          You are giving the Company permission to use, share, and store it in a
          manner consistent with this Privacy Policy.
        </p>
        <h3 className="legal-h3">Tracking Technologies and Cookies</h3>
        <p>
      ...
      <section>
        <h2 className="legal-h2">Use of Your Personal Data</h2>
        ...
        <h3 className="legal-h3">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="legal-h3">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="legal-h3">Disclosure of Your Personal Data</h3>
        <h3 className="legal-h4">Business Transactions</h3>
        <p>
        ...
        <h3 className="legal-h4">Law enforcement</h3>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="legal-h4">Other legal requrements</h3>
        <p>
        ...
        <h3 className="legal-h4">Security of Your Personal Data</h3>
        <p>
      ...
      <section>
        ...
        <ul className="legal-dl-list">
          ...
          <li>
            <dl>
              ...
              <dd>
                ...
                Policy page here:{" "}
                <a target="_blank" rel="noopener noreferrer" href="https://matomo.org/privacy-policy">
          ...
          <li>
            ...
            <dd>
              ...
              Clicky here:{" "}
              <a target="_blank" rel="noopener noreferrer" href="https://clicky.com/terms">
          ...
          <li>
            ...
            <dd>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://statcounter.com/about/legal/">
          ...
          <li>
            ...
            <dd>
              ...
              visit this page:{" "}
              <a target="_blank" rel="noopener noreferrer" href="https://mixpanel.com/optout/">
          ...
          <li>
            ...
            <dd>
              ...
              services. For more information on what type of information Unity
              Technologies collects, please visit their Privacy Policy page:{" "}
              <a
                target="_blank" rel="noopener noreferrer"
        ...
        <h3 className="legal-h3">Email Marketing</h3>
        <p>
        ...
        <h3 className="legal-h3">Behavioural Remarketing</h3>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://www.youronlinechoices.com/">
              http://www.youronlinechoices.com/
            </a>
          </li>
          <li>
            The DAA's opt-out platform:{" "}
            <a target="_blank" rel="noopener noreferrer" href="http://optout.aboutads.info/?c=2&lang=EN">
          ...
          <li>
            <dl>
              ...
              <dd>
                ...
                in the USA{" "}
                <a target="_blank" rel="noopener noreferrer" href="http://www.aboutads.info/choices/">
                  http://www.aboutads.info/choices/
                </a>
                , the Digital Advertising Alliance of Canada in Canada{" "}
                <a target="_blank" rel="noopener noreferrer" href="http://youradchoices.ca/">
                  http://youradchoices.ca/
                </a>{" "}
                or the European Interactive Digital Advertising Alliance in
                Europe{" "}
                <a target="_blank" rel="noopener noreferrer" href="http://www.youronlinechoices.eu/">
      ...
      <section>
        <h2 className="legal-h2">CCPA Privacy</h2>
        <p>
        ...
        <ul className="legal-dl-list">
          ...
          <li>
            <dl>
              ...
              <dt>Examples:</dt>
              <dd>
                Records and history of products or services purchased or
                considered.
              </dd>
              <dt>Collected: </dt>
              <dd>Yes</dd>
        ...
        <h3 className="legal-h3">Sources of Personal Information</h3>
        <p>
          ...
          <li>
            <dl>
              ...
              <dd>
                ...
                advertising to You, third-party vendors for payment processing,
                or other third-party vendors that We use to provide the Service
                to You.
              </dd>
            </dl>
          </li>
        ...
        <h3 className="legal-h3">Sale of Personal Information</h3>
        <p>
          ...
          information, but not necessarily a monetary benefit. Please note that
          the categories listed below are those defined in the CCPA. This does
          not mean that all examples of that category of personal information
          were in fact sold, but reflects our good faith belief to the best of
          our knowledge that some of that information from the applicable
          category may be and may have been shared for value in return. We may
          sell and may have sold in the last twelve (12) months the following
        ...
        <h3 className="legal-h3">Share of Personal Information</h3>
        <p>
        ...
        <h3 className="legal-h3">Your Rights under the CCPA</h3>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            the right to direct Us to not sell Your personal information. To
            submit an opt-out request please contact Us.
          </li>
          <li>
            The right to delete Personal Data. You have the right to request the
            deletion of Your Personal Data, subject to certain exceptions. Once
            We receive and confirm Your request, We will delete (and direct Our
        ...
        <h3 className="legal-h3">Do Not Sell My Personal Information</h3>
        <p>
          ...
          Your right to opt-out, please contact Us. The Service Providers we
          partner with (for example, our analytics or advertising partners) may
          use technology on the Service that sells personal information as
          defined by the CCPA law. If you wish to opt out of the use of Your
          personal information for interest-based advertising purposes and these
          potential sales as defined under CCPA law, you may do so by following
        ...
        <h3 className="legal-h4">Website</h3>
        <p>
        ...
        <h3 className="legal-h4">Mobile Devices</h3>
        <p>
      ...
      <section>
        ...
        <h3 className="legal-h3">Parental Access</h3>
        <p>
      ...
      <section>
        <h2 className="legal-h2">Changes to this Privacy Policy</h2>
        <p>
